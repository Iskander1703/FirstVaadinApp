...
@SpringComponent
@UIScope
public class ShowEditor extends Dialog {
    ...
    @Autowired
    public ShowEditor(ShowDtoService showDtoService) {
        super();
        ...
        this.setHeaderTitle("Изменить мероприятие");
        showId.setEnabled(false);
//        binder.bindInstanceFields(this);
        //При нажатии на Enter мероприятие будет сохраняться
